...
<div class="container">
                ...
                <div class="container-pluid" style="margin-top: 0">
                <section id="footer-button">
                    <div class="container-pluid">
                        <div class="container">
                            ...
                            <div class="col-md-6" id="footer-support">
                                ...
                                <ul>
                                    <li>
                                    <p><i class="sp-ic fa fa-mobile" style="font-size: 22px;padding-right: 5px;"></i>Gọi mua hàng: <strong>0327037017</strong> (7:30 - 18:00)</p>
                    ...
                    <p><i class="fa fa-home" style="font-size: 16px;padding-right: 5px;"></i>Địa chỉ:  10/80C XL Hà Nội, Phường Tân Phú, Thủ Đức, Thành phố Hồ Chí Minh</p>
                    <p><i class="sp-ic fa fa-envelope" style="font-size: 13px;padding-right: 5px;"></i>Email: baolk1230lk@gmail.com</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
